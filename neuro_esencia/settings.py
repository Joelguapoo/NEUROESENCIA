...
SECRET_KEY = 'django-insecure-#7lvl6d()!o^sbz-ug3jr)w__jqd^z4up)3bg_mt9jh48e-0k^'
...
ROOT_URLCONF = 'neuro_esencia.urls'
...
WSGI_APPLICATION = 'neuro_esencia.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'root',
        'PASSWORD': 'CdAQVdfZjQWYUdgakWhpErTFwdLehAwE',
